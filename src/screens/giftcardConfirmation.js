...
class GiftcardConfirmation extends React.Component {
  constructor(props) { 
    super(props);
    this.state={}
...
renderThanks(){
    return(
        <View style={styles.textContainter}>
            <Text style={styles.thanksStyle}>Dziękujemy za skorzystanie z naszych usług.Karta zostanie wysłana na podany w formularzu adres email w ciągu 24H.</Text>
        </View>
    )
}
