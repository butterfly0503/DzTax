...
class RateUsConfirmation extends React.Component {
  constructor(props) { 
    super(props);
    this.state={}
...
renderThanks(){
    return(
        <View style={styles.textContainter}>
            <Text style={styles.thanksStyle}>Dziękujemy za poświęcony czas na ocenę aplikacji!Twoja opinia jest dla nas bardzo ważna:) </Text>
